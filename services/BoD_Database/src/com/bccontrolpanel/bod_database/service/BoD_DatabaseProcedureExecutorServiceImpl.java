...
@Service
public class BoD_DatabaseProcedureExecutorServiceImpl implements BoD_DatabaseProcedureExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(BoD_DatabaseProcedureExecutorServiceImpl.class);

	@Autowired
	@Qualifier("BoD_DatabaseWMProcedureExecutor")
