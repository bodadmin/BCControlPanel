...
@Service
public class UserDatabaseQueryExecutorServiceImpl implements UserDatabaseQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(UserDatabaseQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("UserDatabaseWMQueryExecutor")
