...
package com.bccontrolpanel.userdatabase.dao;
...
/**
* Specifies methods used to obtain and modify Menus related information
* which is stored in the database.
*/
@Repository("UserDatabase.MenusDao")
public class MenusDao extends WMGenericDaoImpl <Menus, Integer> {

    @Autowired
    @Qualifier("UserDatabaseTemplate")
