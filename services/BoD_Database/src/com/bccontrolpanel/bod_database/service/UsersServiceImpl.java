 ...
 */
@Service("BoD_Database.UsersService")
public class UsersServiceImpl implements UsersService {
    ...
    @Transactional(rollbackFor = EntityNotFoundException.class, value = "BoD_DatabaseTransactionManager")
    @Override
