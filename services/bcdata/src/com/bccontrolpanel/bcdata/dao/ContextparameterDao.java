...
/**
* Specifies methods used to obtain and modify Contextparameter related information
* which is stored in the database.
*/
@Repository("bcdata.ContextparameterDao")
public class ContextparameterDao extends WMGenericDaoImpl <Contextparameter, ContextparameterId> {
