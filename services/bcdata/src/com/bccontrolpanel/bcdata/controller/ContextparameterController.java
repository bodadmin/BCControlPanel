...
@Api(description = "Exposes APIs to work with Contextparameter resource.", value = "ContextparameterController")
public class ContextparameterController {
    ...
    public Contextparameter getContextparameter(@RequestParam("contextName") String contextName, @RequestParam("contextFileName") String contextFileName, @RequestParam("parameter") String parameter) throws EntityNotFoundException {
