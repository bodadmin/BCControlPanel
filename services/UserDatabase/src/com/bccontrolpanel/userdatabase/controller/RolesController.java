...
import com.bccontrolpanel.userdatabase.service.RolesService;
import java.io.*;
 ...
 */
@RestController(value = "UserDatabase.RolesController")
@RequestMapping("/UserDatabase/Roles")
@Api(description = "Exposes APIs to work with Roles resource.", value = "RolesController")
public class RolesController {

    private static final Logger LOGGER = LoggerFactory.getLogger(RolesController.class);

    @Autowired
    @Qualifier("UserDatabase.RolesService")
    private RolesService rolesService;

    @RequestMapping(value = "/search", method = RequestMethod.POST)
    @ApiOperation(value = "Returns the list of Roles instances matching the search criteria.")
    public Page<Roles> findRoless(Pageable pageable, @RequestBody QueryFilter[] queryFilters) {
        LOGGER.debug("Rendering Roless list");
        return rolesService.findAll(queryFilters, pageable);
    }

    @RequestMapping(value = "/", method = RequestMethod.GET)
    @ApiOperation(value = "Returns the list of Roles instances.")
    public Page<Roles> getRoless(Pageable pageable) {
        LOGGER.debug("Rendering Roless list");
    ...
    public Roles createRoles(@RequestBody Roles instance) {
        ...
        instance = rolesService.create(instance);
    ...
    public Long countAllRoless() {
        LOGGER.debug("counting Roless");
        Long count = rolesService.countAll();
        return count;
    }
    ...
    public Roles getRoles(@PathVariable("id") Integer id) throws EntityNotFoundException {
        ...
        Roles instance = rolesService.findById(id);
    ...
    public Roles editRoles(@PathVariable("id") Integer id, @RequestBody Roles instance) throws EntityNotFoundException {
        LOGGER.debug("Editing Roles with id: {}", instance.getId());
        instance.setId(id);
        instance = rolesService.update(instance);
        LOGGER.debug("Roles details with id: {}", instance);
        return instance;
    }
    ...
    public boolean deleteRoles(@PathVariable("id") Integer id) throws EntityNotFoundException {
        ...
        Roles deleted = rolesService.delete(id);
        return deleted != null;
    }
}
