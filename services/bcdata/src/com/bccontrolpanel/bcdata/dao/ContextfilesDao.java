...
/**
* Specifies methods used to obtain and modify Contextfiles related information
* which is stored in the database.
*/
@Repository("bcdata.ContextfilesDao")
public class ContextfilesDao extends WMGenericDaoImpl <Contextfiles, Integer> {
