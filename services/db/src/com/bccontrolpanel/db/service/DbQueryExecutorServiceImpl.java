...
@Service
public class DbQueryExecutorServiceImpl implements DbQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(DbQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("dbWMQueryExecutor")
