...
/**
* Specifies methods used to obtain and modify Contextfilename related information
* which is stored in the database.
*/
@Repository("bcdata.ContextfilenameDao")
public class ContextfilenameDao extends WMGenericDaoImpl <Contextfilename, Integer> {
