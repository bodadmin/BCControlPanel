...
/**
* Specifies methods used to obtain and modify Context related information
* which is stored in the database.
*/
@Repository("bcdata.ContextDao")
public class ContextDao extends WMGenericDaoImpl <Context, Integer> {
