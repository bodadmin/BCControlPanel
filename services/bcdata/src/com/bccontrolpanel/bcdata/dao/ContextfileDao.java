...
/**
* Specifies methods used to obtain and modify Contextfile related information
* which is stored in the database.
*/
@Repository("bcdata.ContextfileDao")
public class ContextfileDao extends WMGenericDaoImpl <Contextfile, ContextfileId> {
