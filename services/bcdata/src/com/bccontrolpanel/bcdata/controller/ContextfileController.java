...
@Api(value = "/bcdata/Contextfile", description = "Exposes APIs to work with Contextfile resource.")
...
public class ContextfileController {
	...
	public Contextfile getContextfile( @RequestParam("contextName") String contextName, @RequestParam("contextFileName") String contextFileName)
